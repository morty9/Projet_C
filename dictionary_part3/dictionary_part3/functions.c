    ...
    do {
        ...
        if(dictionaryName != NULL){
            ...
            if(newDictionary == NULL){
                ...
                chooseTextFile(dictionaryName, dictionarys);
            }else {
                fclose(newDictionary);
            }
    ...
    do {
        ...
        while(head != NULL && head->value != NULL){
            if(strcmp(name, head->value) == 0){
                chooseTextFile(name, dictionary);
                found = 1;
                break;
            }
            head = head->next;
...
void deleteDictionary(char* name, char* import, LinkedList* dictionaryList) {
    ...
    if(dictionary != NULL) {
        ...
        do {
            ...
            switch (*choice) {
                ...
                case 110:
                    menu2(name, import, dictionaryList);
                    break;
